...
But now I am fond of my name again and I'm also looking back on that cultural moment with a new lens thanks to Monica Lewinsky's awesome [talk](https://www.ted.com/talks/monica_lewinsky_the_price_of_shame). However, with the `babynames` package on CRAN, I had to take a look at where 'Monica' falls on the poisoned names list. 
...
The risk difference[^2] is used to describe the "public health impact" and to "put the association between and exposure and outcome into a meaningful public health context."[^3] The *risk difference (RD)* is the difference in proportionsit tells us what the *excess risk* of disease is among those who have been exposed to something vs. those who have not been exposed. In the study on alcohol use and breast cancer mentioned above, a 40-year-old woman has an absolute risk of 1.45 of developing breast cancer in the next 10 years. If she is a light drinker, this risk becomes 1.51 percent. The risk ratio is 1.51/1.45 = `r 1.51/1.45`, or a 4% increase in risk. However, the risk difference is 1.51-1.45 = `r 1.51-1.45`, or an excess risk of .06 per 100. That's 1.2 people for every 2,000 light drinkers. When you put it in absolute terms, the RD brings a different perspective to certain types of risk.

Would the risk difference say about these poisoned names? Let's calculate the risk differences in our babynames data set. In this analysis, we can think of the year as the "exposure" and the name as the "outcome." We can think caculate the "risk" or probability of being named Monica in any given year compared to the prior year. To make this more interpretable, I also caculated the excess risk, or how many people were named Monica in a year per 10,000 people named compared to the previous year, by multiplying the risk difference by 10,000.
...
And Hillary wins with an excess risk of -7.2 per 10,000 babies in 1993! It's even larger if you combine Hilary and Hillary. Interestingly, Hi**ll**ary had a larger risk difference compared to Hi**l**ary in 1993. Using the risk ratio, Hi**l**ary is the more poisoned name.
...
[^2]: Here's a [diagram](http://sphweb.bumc.bu.edu/otlt/mph-modules/ep/ep713_association/EP713_Association5.html) to illustrate the risk difference and excess risk.
[^3] See: https://www.cdc.gov/ophss/csels/dsepd/ss1978/lesson3/section6.html. The risk differnce is sometimes called the attributable risk. 
