...
Would the risk difference say about these poisoned names? I'll calculate the risk differences in the babynames data set. In this analysis, we can think of the year as the "exposure" and the name as the "outcome." We can think calculate the "risk" or probability of being named Monica in any given year compared to the prior year. To make this more interpretable, I also caculated the excess risk, or how many people were named Monica in a year per 10,000 people named compared to the previous year, by multiplying the risk difference by 10,000.
...
P.S. Seriously, watch this [talk]((https://www.ted.com/talks/monica_lewinsky_the_price_of_shame)) or read this [story](https://www.vanityfair.com/news/2018/02/monica-lewinsky-in-the-age-of-metoo) by Monica Lewinsky. It's inspiring and adds a lot to current conversations about harrassment and bullying.
