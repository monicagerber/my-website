...
# note, J.Draper -- no clue whatsoever why, but this seems to work for me:
df <- child_data[1:nrow(child_data), ]
df$bmiz <- AGD::y2z(y = df$bmi, x = df$ageyears, sex = df$sex_mf, ref = cdc.bmi)
```
